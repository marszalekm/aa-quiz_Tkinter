...
with open('aminoacids-list.txt', 'r') as f:
    for line in f:
        ...
        extracted from aforementioned file.
        '''
...
class Quiz:
    ...
    def __init__(self, root):
        """
        Establishment of basic parts of quiz.
        """
        ...
        self.titletext = tk.Label(self.frame,
                                  text=" Welcome to aminoacids quiz. Pick which type of test you would like.")
    ...
    def draw(self):
        ...
        if self.olet is True and self.tlet is False:
            ...
            self.amino.configure(text=str(self.rand[2]))
    ...
    def result(self):
        ...
        """
        box = self.entry.get()
        box = box.lower().capitalize()
        if self.olet is True and box == self.rand[0]:
            self.score.configure(text="Correct ")
        elif self.tlet is True and box == self.rand[1]:
            self.score.configure(text="Correct ")
        elif box == '':
